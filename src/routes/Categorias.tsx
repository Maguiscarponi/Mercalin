  ...
  return (
    <div className="flex-1 flex flex-col gap-3 overflow-hidden">
      ...
      <div className="card flex-1 overflow-y-auto">
        {creating && (
          <div className="flex gap-2 items-center px-4 py-3 border-b border-stone-100 bg-red-50/40">
            <input
              autoFocus
                  ...
                  <td className="px-4 py-3">
                    {renamingName === cat.name ? (
                      ...
                      <button
                        ...
                        className="font-medium text-stone-800 hover:text-red-600 hover:underline text-left"
